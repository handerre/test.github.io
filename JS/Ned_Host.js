    ...
    var countDownDate_H = new Date("Oct 11, 2021 13:46:00").getTime();
    ...
    var x = setInterval(function() {
      ...
      var distance = countDownDate_H - now;
      ...
      document.getElementById("nedtelling_H").innerHTML = "Hvor lenge til høstferien: "+ days + "d " + hours + "h "
      + minutes + "m " + seconds + "s ";
